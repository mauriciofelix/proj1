...
const routes: VexRoutes = [
  ...
  },
  {
    ...
    children: [
      {
        path: 'apps/products/table',
        redirectTo: ''
      },
      {
        path: '',
        //loadChildren: () => import('./pages/dashboards/dashboard-analytics/dashboard-analytics.module').then(m => m.DashboardAnalyticsModule),        
        loadChildren: () => import('./pages/apps/products/products-table/products-table.module').then(m => m.ProductsTableModule),
      },
      {
        path: 'apps',
        children: [
          ...
          {
            path: 'products',
            loadChildren: () => import('./pages/apps/products/products.module').then(m => m.ProductsModule)
          },
          {
            path: 'calendar',
